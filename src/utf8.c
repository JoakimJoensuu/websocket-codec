...
static const struct {
  ...
  int rest;
    ...
    {
        U0080_U07FF_FIRST_MIN,
        U0080_U07FF_FIRST_MAX,
        CONT_MIN,
        CONT_MAX,
        REST_U0080_U07FF,
    },
    {
        U0800_U0FFF_FIRST,
        U0800_U0FFF_FIRST,
        U0800_U0FFF_SECOND_MIN,
        CONT_MAX,
        REST_U0800_UFFFF,
    },
    {
        U1000_UCFFF_FIRST_MIN,
        U1000_UCFFF_FIRST_MAX,
        CONT_MIN,
        CONT_MAX,
        REST_U0800_UFFFF,
    },
    {
        ...
        UD000_UD7FF_FIRST,
        CONT_MIN,
        UD000_UD7FF_SECOND_MAX,
        REST_U0800_UFFFF,
    },
    {
        UE000_UFFFF_FIRST_MIN,
        UE000_UFFFF_FIRST_MAX,
        CONT_MIN,
        CONT_MAX,
        REST_U0800_UFFFF,
    },
    {
        U10000_U3FFFF_FIRST,
        U10000_U3FFFF_FIRST,
        U10000_U3FFFF_SECOND_MIN,
        CONT_MAX,
        REST_U10000_U10FFFF,
    },
    {
        U40000_UFFFFF_FIRST_MIN,
        U40000_UFFFFF_FIRST_MAX,
        CONT_MIN,
        CONT_MAX,
        REST_U10000_U10FFFF,
    },
    {
        U100000_U10FFFF_FIRST,
        U100000_U10FFFF_FIRST,
        CONT_MIN,
        U100000_U10FFFF_SECOND_MAX,
        REST_U10000_U10FFFF,
    },
};
...
static int feed_byte(struct utf8 *state, unsigned byte) {
  if (state->need == 0) {
    if (byte <= U0000_U007F_MAX) {
      return 0;
    }
    for (size_t row = 0; row < sizeof well_formed / sizeof well_formed[0]; row++) {
      if (byte >= well_formed[row].first_min && byte <= well_formed[row].first_max) {
...
int utf8_finish(const struct utf8 *state) { return state->need == 0 ? 0 : -1; }
